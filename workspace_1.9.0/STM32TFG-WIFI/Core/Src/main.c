...
/* Private macro -------------------------------------------------------------*/
/* USER CODE BEGIN PM */
extern void PrintTask(void *parg);
extern void WebServerTask(void *pArg);
/* USER CODE END PM */
...
const osThreadAttr_t RxTask_attributes = { .name = "RxTask", .stack_size = 128
...
const osThreadAttr_t WebServerTask_attributes = { .name = "WebServerTask",
		.stack_size = 128 * 4, .priority = (osPriority_t) osPriorityNormal, };
/* Definitions for instructionQueue */
osMessageQueueId_t instructionQueueHandle;
const osMessageQueueAttr_t instructionQueue_attributes = { .name =
		"instructionQueue" };
/* Definitions for xSemaphoreSerial */
osSemaphoreId_t xSemaphoreSerialHandle;
const osSemaphoreAttr_t xSemaphoreSerial_attributes = { .name =
		"xSemaphoreSerial" };
/* USER CODE BEGIN PV */
...
int main(void) {
	...
	instructionQueueHandle = osMessageQueueNew(100,
			sizeof(MovementInstruction_t), &instructionQueue_attributes);
